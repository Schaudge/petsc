...
static PetscErrorCode DMTaoApplyProximalMap_L1(DMTao dm0, DMTao dm1, PetscReal lambda, Vec y, Vec x, void *ptr)
{
  ...
  PetscAssert(is_0_l1, PetscObjectComm((PetscObject)dm0), PETSC_ERR_USER, "DMTaoApplyProximalMap_L1 requires first DMTao to be of L1 type");
  PetscAssert(is_1_l2, PetscObjectComm((PetscObject)dm1), PETSC_ERR_USER, "DMTaoApplyProximalMap_L1 requires second DMTao to be of L2 type");
