...
/*TEST
  ...
  test:
    suffix: 1
    args: -tao_monitor -tao_ls_gtol 1.e-6 -tao_view -tao_lmvm_mat_lmvm_hist_size 20 -tao_ls_type more-thuente -tao_lmvm_mat_type lmvmcdbfgs -tao_lmvm_mat_lbfgs_type {{cd_inplace cd_reorder}}
