...
int main(int argc, char **argv)
{
  ...
  */
  ...
  BLASgemm_("T", "N", &Nl, &Nl2, &Nl, &alpha, &A[0][0], &Nl, &ulb[0][0][0], &Nl, &beta, &wrk1[0][0][0], &Nl);
  for (jx = 0; jx < Nl; jx++)
  {
    temp1 = &wrk1[0][0][0] + jx * Nl2;
    temp2 = &wrk2[0][0][0] + jx * Nl2;

    BLASgemm_("N", "N", &Nl, &Nl, &Nl, &alpha, temp1, &Nl, &B[0][0], &Nl, &beta, temp2, &Nl);
  }

  BLASgemm_("N", "N", &Nl2, &Nl, &Nl, &alpha, &wrk2[0][0][0], &Nl2, &C[0][0], &Nl, &beta, &wrk3[0][0][0], &Nl2);
