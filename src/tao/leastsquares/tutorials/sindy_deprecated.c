...
/* Deprecated. */
static PetscErrorCode SINDyInitializeBasesNames(Basis basis) {
  PetscErrorCode   ierr;
...
/* Deprecated. */
PetscErrorCode SINDyFindSparseCoefficients(Basis basis, SparseReg sparse_reg, PetscInt N, Vec* dxdt, PetscInt dim, Vec* Xis)
{
  PetscErrorCode  ierr;
  PetscInt        i,d,k,b;
