...
const char *const TaoMADSubsolvers[]        = {"LSQR","NORMAL","SVD","TaoMADSubsolver","TAO_MAD_SUBSOLVER_",NULL};
const char *const TaoMADFilters[]           = {"NONE","SIMPLE","BARRIER","MARKOV","TaoMADFilterType","TAO_MAD_FILTER_",NULL};
/*@C
