...
/*TEST
   ...
   test:
      args: -tao_cmonitor -tao_type ssils -tao_grtol 1.e-5
      requires: !single

   test:
      suffix: 2
      args: -tao_cmonitor -tao_type ssfls -tao_max_it 10 -tao_grtol 1.e-5
      requires: !single

   test:
      suffix: 3
      args: -tao_cmonitor -tao_type asils -tao_subset_type subvec -tao_grtol 1.e-5
      requires: !single

   test:
      suffix: 4
      args: -tao_cmonitor -tao_type asils -tao_subset_type mask -tao_grtol 1.e-5
      requires: !single

   test:
      suffix: 5
      args: -tao_monitor -tao_type asils -tao_subset_type matrixfree -pc_type jacobi -tao_max_it 6 -tao_grtol 1.e-5
      requires: !single

   test:
      suffix: 6
      args: -tao_cmonitor -tao_type asfls -tao_subset_type subvec -tao_max_it 10 -tao_grtol 1.e-5
      requires: !single

   test:
      suffix: 7
      args: -tao_cmonitor -tao_type asfls -tao_subset_type mask -tao_max_it 10 -tao_grtol 1.e-5
      requires: !single
