...
PETSC_INTERN PetscErrorCode TaoMappedTermHessianMult(TaoMappedTerm *mt, Vec x, Vec params, Mat unmapped_H, Vec v, InsertMode mode, Vec Hv)
{
  Vec Av;
  ...
  else PetscCall(TaoTermHessianMult(mt->term, x, params, Av, unmapped_Hv));
