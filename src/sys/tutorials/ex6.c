...
// but they can access global logging information.  If your log
// handler only needs to interact with the arguments to the callback functions
// and global data structures, the legacy callbacks can be used.
