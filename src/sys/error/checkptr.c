...
#define PetscCheckMpiCupmAwarenessFunc     \
PetscBool PetscCheckMpiCupmAwareness(void) \
{ \
  ...
  #define PetscCheckMpiCupmAwareness PetscCheckMpiCudaAwareness
  PetscCheckMpiCupmAwarenessFunc
#endif
  ...
  #define PetscCheckMpiCupmAwareness PetscCheckMpiHipAwareness
  PetscCheckMpiCupmAwarenessFunc
#endif
...
#if defined (PETSC_HAVE_CUDA)
PetscBool PetscCheckMpiCudaAwareness(void)
{
...
#if defined (PETSC_HAVE_HIP)
PetscBool PetscCheckMpiHipAwareness(void)
{
  /* If no setjmp (rare), return true and let users code run (and segfault if they should) */
  return PETSC_TRUE;
}
