...
PETSC_INTERN PetscErrorCode PetscViewerCreate_Conduit(PetscViewer);
...
#endif
#if defined(PETSC_HAVE_CONDUIT)
  ierr = PetscViewerRegister(PETSCVIEWERCONDUIT,     PetscViewerCreate_Conduit);CHKERRQ(ierr);
#endif
