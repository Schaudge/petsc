...
PETSC_EXTERN PetscErrorCode PetscViewerCreate_Python(PetscViewer);
...
#endif
#if defined(PETSC_HAVE_PETSC4PY)
  PetscCall(PetscViewerRegister(PETSCVIEWERPYTHON, PetscViewerCreate_Python));
#endif
