...
/*@C
  PetscViewerFinalizePackage - Destroys any global objects created in the Petsc viewers. It is
...
/*@C
  PetscViewerInitializePackage - Initializes everything in the main PetscViewer package.
