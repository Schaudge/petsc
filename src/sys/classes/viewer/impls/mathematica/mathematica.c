...
/*@C
  PetscViewerMathematicaFinalizePackage - Destroys everything in the Petsc interface to Mathematica. It is
...
/*@C
  PetscViewerMathematicaInitializePackage - Initializes everything in the Petsc interface to Mathematica. It is
