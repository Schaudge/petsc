...
static struct _PetscRandomOps PetscRandomOps_Values = {
  PetscDesignatedInitializer(seed, PetscRandomSeed_Random123),           PetscDesignatedInitializer(getvalue, PetscRandomGetValue_Random123),           PetscDesignatedInitializer(getvaluereal, PetscRandomGetValueReal_Random123),
  PetscDesignatedInitializer(getvalues, PetscRandomGetValues_Random123), PetscDesignatedInitializer(getvaluesreal, PetscRandomGetValuesReal_Random123), PetscDesignatedInitializer(destroy, PetscRandomDestroy_Random123),
};
