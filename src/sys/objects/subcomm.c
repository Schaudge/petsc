...
{
  PetscErrorCode ierr;
  PetscMPIInt    rank,size,np_subcomm,nleftover;
  PetscMPIInt    duprank=-1,subrank=-1,color=-1,rankstart=0,nsubcomm=psubcomm->n;
  PetscMPIInt    *subsize;
  ...
  for (PetscMPIInt i = 0; i < nsubcomm; ++i) {
...
PetscErrorCode PetscSubcommSetOptionsPrefix(PetscSubcomm psubcomm,const char pre[])
{
  ...
  if (pre) {
    ...
    if (PetscUnlikely(pre[0] == '-')) SETERRQ(PETSC_COMM_SELF,PETSC_ERR_ARG_WRONG,"Options prefix should not begin with a hyphen");
    ierr = PetscFree(psubcomm->subcommprefix);CHKERRQ(ierr);
    ierr = PetscStrallocpy(pre,&(psubcomm->subcommprefix));CHKERRQ(ierr);
  } else {ierr = PetscFree(psubcomm->subcommprefix);CHKERRQ(ierr);}
  PetscFunctionReturn(0);
}
...
PetscErrorCode  PetscSubcommSetNumber(PetscSubcomm psubcomm,PetscInt nsubcomm)
{
  ...
  if (PetscUnlikely(msub < 1 || msub > size)) SETERRQ2(PETSC_COMM_SELF,PETSC_ERR_ARG_OUTOFRANGE, "Num of subcommunicators %d cannot be < 1 or > input comm size %d",msub,size);
...
.seealso: PetscSubcommDestroy(), PetscSubcommSetTypeGeneral(), PetscSubcommSetFromOptions(), PetscSubcommSetType(),
          PetscSubcommSetNumber(), PetscSubcommGetChild(), PetscSubcommGetContiguousParent(), PetscSubcommGetColor()
@*/
...
.seealso: PetscSubcommDestroy(), PetscSubcommSetTypeGeneral(), PetscSubcommSetFromOptions(), PetscSubcommSetType(),
          PetscSubcommSetNumber(), PetscSubcommGetChild(), PetscSubcommGetColor()
@*/
...
.seealso: PetscSubcommDestroy(), PetscSubcommSetTypeGeneral(), PetscSubcommSetFromOptions(), PetscSubcommSetType(),
          PetscSubcommSetNumber(), PetscSubcommGetParent(), PetscSubcommGetContiguousParent(), PetscSubcommGetColor()
@*/
...
.seealso: PetscSubcommDestroy(), PetscSubcommSetTypeGeneral(), PetscSubcommSetFromOptions(), PetscSubcommSetType(),
          PetscSubcommSetNumber(), PetscSubcommGetParent(), PetscSubcommGetContiguousParent()
@*/
