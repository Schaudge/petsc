...
PETSC_EXTERN PetscErrorCode MatPartitioningCreate_Kahip(MatPartitioning);
#endif
...
#endif
#if defined(PETSC_HAVE_KAHIP)
  ierr = MatPartitioningRegister(MATPARTITIONINGKAHIP,MatPartitioningCreate_Kahip);CHKERRQ(ierr);
#endif
