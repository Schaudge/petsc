...
PETSC_INTERN PetscErrorCode MatSetOption_PropagateDiagonal(Mat, Mat, MatOption, PetscBool);
PETSC_INTERN PetscErrorCode MatPropagateSymmetryOptions_Diagonal(Mat, Mat);
