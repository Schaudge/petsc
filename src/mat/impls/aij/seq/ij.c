...
*/
PetscErrorCode MatToSymmetricIJ_SeqAIJ(PetscInt m,PetscBigInt *ai,PetscInt *aj,PetscBool lower_triangular,PetscInt shiftin,PetscInt shiftout,PetscInt **iia,PetscInt **jja)
{
  PetscErrorCode ierr;
  ...
  ierr = PetscCalloc1(m+1,&ia);CHKERRQ(ierr);
  *iia = ia;
