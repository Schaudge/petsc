...
//
// This factorization exploits block diagonal matrices with "Nf". Not used. Can activate if we know batch size
...
static PetscErrorCode MatLUFactorNumeric_SeqAIJKOKKOSDEVICE(Mat B,Mat A,const MatFactorInfo *info)
{
  ...
  PetscInt           nc, Nf=1, nVec=32; // should be a parameter, Nf is batching parameter, not used
