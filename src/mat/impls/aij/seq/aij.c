...
PetscErrorCode  MatDiagonalSet_SeqAIJ(Mat Y,Vec D,InsertMode is)
{
  ...
  const PetscScalar *v;
  PetscBool         missing;
#if defined(PETSC_HAVE_VIENNACL) || defined(PETSC_HAVE_CUDA) || defined(PETSC_HAVE_KOKKOS)
...
{
#if defined(PETSC_HAVE_CUDA) || defined(PETSC_HAVE_VIENNACL) || defined(PETSC_HAVE_KOKKOS)
