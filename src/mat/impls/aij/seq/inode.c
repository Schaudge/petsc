        ...
        for (k=0; k < nzL; k++) {
          ...
          if (*pc1 != 0.0 || *pc2 != 0.0 || *pc3 != 0.0) {
            ...
            *pc1 = mul1; *pc2 = mul2; *pc3 = mul3;
            ...
            ierr = PetscLogFlops(3+6*nz);CHKERRQ(ierr);
          }
          row = *bjtmp++;
        }
        ...
        for (k=0; k < nzL; k++) {
          ...
          if (*pc1 != 0.0 || *pc2 != 0.0 || *pc3 != 0.0 || *pc4 != 0.0) {
            ...
            *pc1 = mul1; *pc2 = mul2; *pc3 = mul3; *pc4 = mul4;
            ...
            ierr = PetscLogFlops(4+8*nz);CHKERRQ(ierr);
          }
          row = *bjtmp++;
        }
        ...
        while (prow < row) {
          ...
          if (*pc1 != 0.0) {
            ...
            *pc1   = mul1;
            ...
            ierr   = PetscLogFlops(1+2*nz_tmp);CHKERRQ(ierr);
            for (j=0; j<nz_tmp; j++) {
              tmp          = pv[j];
              idx          = pj[j];
              rtmp11[idx] -= mul1 * tmp;
        ...
        while (prow < row) {
          ...
          if (*pc1 != 0.0 || *pc2 != 0.0) {
            ...
            *pc2 = mul2;
            ...
            ierr = PetscLogFlops(2+4*nz_tmp);CHKERRQ(ierr);
          }
          prow = *bjtmp++;
        }
        ...
        while (prow < row) {
          ...
          if (*pc1 != 0.0 || *pc2 != 0.0 || *pc3 !=0.0) {
            ...
            *pc3 = mul3;
            ...
            ierr = PetscLogFlops(3+6*nz_tmp);CHKERRQ(ierr);
          }
          prow = *bjtmp++;
        }
...
PetscErrorCode MatSeqAIJCheckInode(Mat A)
{
  ...
  {
    PetscBool is_gputype;
    ierr = PetscObjectTypeCompareAny((PetscObject)A,&is_gputype, MATAIJCUSPARSE, MATSEQAIJCUSPARSE, MATMPIAIJCUSPARSE, MATAIJVIENNACL, MATSEQAIJVIENNACL, MATMPIAIJVIENNACL,MATAIJAXB,MATSEQAIJAXB,MATMPIAIJAXB,"");CHKERRQ(ierr);
    if (is_gputype) {
