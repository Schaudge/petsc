...
{
  PetscFunctionBegin;
  MatMultTransposeKernel_MPIDense(A, xx, yy, PETSC_FALSE);
  PetscFunctionReturn(PETSC_SUCCESS);
}
...
{
  PetscFunctionBegin;
  MatMultTransposeAddKernel_MPIDense(A, xx, yy, zz, PETSC_FALSE);
  PetscFunctionReturn(PETSC_SUCCESS);
}
...
{
  PetscFunctionBegin;
  MatMultTransposeKernel_MPIDense(A, xx, yy, PETSC_TRUE);
  PetscFunctionReturn(PETSC_SUCCESS);
}
...
{
  PetscFunctionBegin;
  MatMultTransposeAddKernel_MPIDense(A, xx, yy, zz, PETSC_TRUE);
  PetscFunctionReturn(PETSC_SUCCESS);
}
