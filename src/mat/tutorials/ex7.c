...
/*TEST
   ...
   test:
      ...
      suffix: 1
      args: -info
      filter: grep -h -ve MallocType -ve Running -ve communicator -ve MPI_Comm -ve OpenMP -ve PetscGetHostName -ve PetscDetermineInitialFPTrap

   test:
      requires: define(PETSC_USE_INFO)
      suffix: 2
      args: -info ex7info.2
      filter: grep -h -ve MallocType -ve Running -ve communicator -ve MPI_Comm -ve OpenMP -ve PetscGetHostName -ve PetscDetermineInitialFPTrap "ex7info.2.0"
   ...
   test:
      ...
      nsize: 2
      args: -info ex7info.3
      filter: grep -h -ve MallocType -ve Running -ve communicator -ve MPI_Comm -ve OpenMP -ve PetscGetHostName  -ve PetscDetermineInitialFPTrap "ex7info.3.0" | sort -b
