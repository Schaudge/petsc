...
PETSC_EXTERN void matfdcoloringgetperturbedcolumns_(MatFDColoring *x, F90Array1d *ptr, int *__ierr PETSC_F90_2PTR_PROTO(ptrd))
{
  const PetscInt *fa;
  PetscInt        len;
...
PETSC_EXTERN void matfdcoloringrestoreperturbedcolumns_(MatFDColoring *x, F90Array1d *ptr, int *__ierr PETSC_F90_2PTR_PROTO(ptrd))
{
