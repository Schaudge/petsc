...
#endif
!
!     HIPSPARSE enumerated types
!
/*TODO: SEK -- check */
#if defined(PETSC_HAVE_HIP)
      PetscEnum MAT_HIPSPARSE_CSR
      PetscEnum MAT_HIPSPARSE_ELL
      PetscEnum MAT_HIPSPARSE_HYB
      parameter(MAT_HIPSPARSE_CSR=0,MAT_HIPSPARSE_ELL=1)
      parameter(MAT_HIPSPARSE_HYB=2)
      PetscEnum MAT_HIPSPARSE_MULT_DIAG
      PetscEnum MAT_HIPSPARSE_MULT_OFFDIAG
      PetscEnum MAT_HIPSPARSE_MULT
      PetscEnum MAT_HIPSPARSE_ALL
      parameter(MAT_HIPSPARSE_MULT_DIAG=0)
      parameter(MAT_HIPSPARSE_MULT_OFFDIAG=1)
      parameter(MAT_HIPSPARSE_MULT=2)
      parameter(MAT_HIPSPARSE_ALL=3)
#endif
!
