...
/*TEST
   ...
   test:
     ...
     filter: grep -h -ve MallocType -ve Running -ve MPI_Comm -ve Initialize -ve communicator -ve HostName -ve PetscDetermineInitialFPTrap "ex182info.0" | sort -b
   ...
   test:
     ...
     filter: grep -h -ve MallocType -ve Running -ve MPI_Comm -ve Initialize -ve communicator -ve HostName -ve PetscDetermineInitialFPTrap "ex182info.1" | sort -b
