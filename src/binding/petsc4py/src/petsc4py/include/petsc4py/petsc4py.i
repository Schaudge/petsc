...
%define SWIG_TYPECHECK_PETSC_DEVICE_CONTEXT   503 %enddef
...
%define SWIG_TYPECHECK_PETSC_DMTAO            535 %enddef
...
%petsc4py_objt( Petsc , DeviceContext  , PetscDeviceContext     , PETSC_DEVICE_CONTEXT   )
...
%petsc4py_objt( Petsc , DMTAO          , DMTao                  , PETSC_DMTAO            )
...
%petsc4py_objt( Petsc , Space          , PetscSpace             , PETSC_SPACE            )
