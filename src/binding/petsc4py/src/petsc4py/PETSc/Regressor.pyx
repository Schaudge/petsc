...
class RegressorType:
    ...
    PYTHON = S_(PETSCREGRESSSORPYTHON)
...
cdef class Regressor(Object):
    ...
    def createPython(self, context: Any = None, comm: Comm | None = None) -> Self:
        """Create an regressor solver of Python type.
    ...
    def setPythonContext(self, context: Any) -> None:
        ...
        See Also
        --------
        petsc_python_regressor, getPythonContext
    ...
    def getPythonContext(self) -> Any:
        ...
        See Also
        --------
        petsc_python_regressor, setPythonContext
    ...
    def setPythonType(self, py_type: str) -> None:
        ...
        See Also
        --------
        petsc_python_regressor, setPythonContext, getPythonType
        petsc.RegressorPythonSetType
    ...
    def getPythonType(self) -> str:
        ...
        See Also
        --------
        petsc_python_regressor, setPythonContext, setPythonType
        petsc.RegressorPythonGetType
