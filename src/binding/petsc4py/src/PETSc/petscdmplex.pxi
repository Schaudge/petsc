...
cdef extern from * nogil:
    ...
    int DMPlexGetDepthStratumNumbering(PetscDM,PetscInt,PetscIS*,const PetscBool**,void*,void*)
    int DMPlexGetHeightStratumNumbering(PetscDM,PetscInt,PetscIS*,const PetscBool**,void*,void*)
