...
.seealso: `PCGAMG`, `PCGAMGSetThreshold()`, `PCGAMGMISkSetAggressive()`, `PCGAMGSetAggressiveSquareGraph()`, `PCGAMGMISSetMinDegreeOrdering()`, `PCGAMGSetLowMemoryFilter()`
@*/
...
.seealso: `PCGAMG`, `PCGAMGSetThreshold()`, `PCGAMGSetAggressiveLevels()`, `PCGAMGSetAggressiveSquareGraph()`, `PCGAMGMISSetMinDegreeOrdering()`, `PCGAMGSetLowMemoryFilter()`
@*/
...
.seealso: `PCGAMG`, `PCGAMGSetThreshold()`, `PCGAMGSetAggressiveLevels()`, `PCGAMGMISkSetAggressive()`, `PCGAMGMISSetMinDegreeOrdering()`, `PCGAMGSetLowMemoryFilter()`
@*/
...
/*@
  PCGAMGMISSetMinDegreeOrdering - Use minimum degree ordering in greedy MIS algorithm
...
- b  - default true
  ...
  Options Database Key:
. -pc_gamg_mis_minimum_degree_ordering <bool,default=true> - Use minimum degree ordering in greedy MIS algorithm
...
@*/
PetscErrorCode PCGAMGMISSetMinDegreeOrdering(PC pc, PetscBool b)
{
  PetscFunctionBegin;
  PetscValidHeaderSpecific(pc, PC_CLASSID, 1);
  PetscValidLogicalCollectiveBool(pc, b, 2);
  PetscTryMethod(pc, "PCGAMGMISSetMinDegreeOrdering_C", (PC, PetscBool), (pc, b));
  PetscFunctionReturn(PETSC_SUCCESS);
}
...
.seealso: `PCGAMG`, `PCGAMGSetThreshold()`, `PCGAMGSetAggressiveLevels()`, `PCGAMGMISkSetAggressive()`, `PCGAMGSetAggressiveSquareGraph()`, `PCGAMGMISSetMinDegreeOrdering()`
@*/
...
static PetscErrorCode PCGAMGMISSetMinDegreeOrdering_AGG(PC pc, PetscBool b)
{
  PC_MG       *mg          = (PC_MG *)pc->data;
  PC_GAMG     *pc_gamg     = (PC_GAMG *)mg->innerctx;
  PC_GAMG_AGG *pc_gamg_agg = (PC_GAMG_AGG *)pc_gamg->subctx;
...
static PetscErrorCode PCDestroy_GAMG_AGG(PC pc)
{
  ...
  PetscCall(PetscObjectComposeFunction((PetscObject)pc, "PCGAMGMISSetMinDegreeOrdering_C", NULL));
...
PetscErrorCode PCCreateGAMG_AGG(PC pc)
{
  ...
  PetscCall(PetscObjectComposeFunction((PetscObject)pc, "PCGAMGMISSetMinDegreeOrdering_C", PCGAMGMISSetMinDegreeOrdering_AGG));
