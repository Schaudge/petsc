...
PetscErrorCode PCBDDCSetupFETIDPMatContext(FETIDPMat_ctx fetidpmat_ctx)
{
  ...
  if (PetscDefined(USE_DEBUG)) {
    ...
    if (i != fetidpmat_ctx->n_lambda) SETERRQ2(PETSC_COMM_WORLD,PETSC_ERR_PLIB,"Global number of multipliers mismatch! (%" PetscInt_FMT " != %" PetscInt_FMT ")",fetidpmat_ctx->n_lambda,i);
  }
