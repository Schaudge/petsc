...
PetscErrorCode KSPMonitorRegisterAll(void)
{
  ...
  ierr = KSPMonitorRegister("preconditioned_residual:"       "ascii:" "DEFAULT", KSPMonitorResidual,           NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("preconditioned_residual:"       "draw:"  "DEFAULT", KSPMonitorResidualDraw,       NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("preconditioned_residual:"       "draw:"  "DRAW_LG", KSPMonitorResidualDrawLG,     KSPMonitorResidualDrawLGCreate, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("preconditioned_residual_short:" "ascii:" "DEFAULT", KSPMonitorResidualShort,      NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("preconditioned_residual_range:" "ascii:" "DEFAULT", KSPMonitorResidualRange,      NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("true_residual:"                 "ascii:" "DEFAULT", KSPMonitorTrueResidual,       NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("true_residual:"                 "draw:"  "DEFAULT", KSPMonitorTrueResidualDraw,   NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("true_residual:"                 "draw:"  "DRAW_LG", KSPMonitorTrueResidualDrawLG, KSPMonitorTrueResidualDrawLGCreate, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("true_residual_max:"             "ascii:" "DEFAULT", KSPMonitorTrueResidualMax,    NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("error:"                         "ascii:" "DEFAULT", KSPMonitorError,              NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("error:"                         "draw:"  "DEFAULT", KSPMonitorErrorDraw,          NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("error:"                         "draw:"  "DRAW_LG", KSPMonitorErrorDrawLG,        KSPMonitorErrorDrawLGCreate, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("solution:"                      "ascii:" "DEFAULT", KSPMonitorSolution,           NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("solution:"                      "draw:"  "DEFAULT", KSPMonitorSolutionDraw,       NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("solution:"                      "draw:"  "DRAW_LG", KSPMonitorSolutionDrawLG,     KSPMonitorSolutionDrawLGCreate, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("singular_value:"                "ascii:" "DEFAULT", KSPMonitorSingularValue,      KSPMonitorSingularValueCreate, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("lsqr_residual:"                 "ascii:" "DEFAULT", KSPLSQRMonitorResidual,       NULL, NULL);CHKERRQ(ierr);
  ierr = KSPMonitorRegister("lsqr_residual:"                 "draw:"  "DRAW_LG", KSPLSQRMonitorResidualDrawLG, KSPLSQRMonitorResidualDrawLGCreate, NULL);CHKERRQ(ierr);
  PetscFunctionReturn(0);
}
