...
/*
   This example focuses on setting the subdomains for the ASM
...
int main(int argc,char **args)
{
  ...
  */
  ...
  /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
     ...
     The ASM default is to use 1 block per processor.  To
  ...
  if (flg) {
    ...
    */
    ...
    /*
       ...
       KSPSetUp() MUST be called before PCASMGetSubKSP().
    */
