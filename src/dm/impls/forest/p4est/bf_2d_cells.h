...
PetscErrorCode DMBF_2D_CellsAmrAdapt(DM_BF_2D_Cells*,DM_BF_2D_Cells**,DM,DM_BF_AmrOps*,PetscInt,PetscInt,size_t,size_t,size_t);
PetscErrorCode DMBF_2D_CellsAmrPartition(DM_BF_2D_Cells*);
PetscErrorCode DMBF_2D_CellsAmrFinalize(DM,DM_BF_2D_Cells*,DM_BF_Cell*,size_t);
