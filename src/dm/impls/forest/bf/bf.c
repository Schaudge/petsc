...
static PetscErrorCode DMSetUp_BF(DM dm)
{
  ...
  switch (dim) {
  case 2:
    ierr = DMBF_2D_CellsCreate(dm, (DM_BF_2D_Topology *)bf->ftTopology, (DM_BF_2D_Cells **)&bf->ftCells, bf->setUpUserFnAfterP4estCells);
    CHKERRQ(ierr);
    break;
  case 3:
    ierr = DMBF_3D_CellsCreate(dm, (DM_BF_3D_Topology *)bf->ftTopology, (DM_BF_3D_Cells **)&bf->ftCells, bf->setUpUserFnAfterP4estCells);
    CHKERRQ(ierr);
    break;
  default:
    _p_SETERRQ_UNREACHABLE(dm);
