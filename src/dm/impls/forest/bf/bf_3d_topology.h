...
PetscErrorCode DMBF_3D_TopologyCreate(DM, DM_BF_3D_Topology **, PetscErrorCode (*)(DM, void *));
PetscErrorCode DMBF_3D_TopologyDestroy(DM, DM_BF_3D_Topology *);
PetscErrorCode DMBF_3D_TopologyClone(DM_BF_3D_Topology *, DM_BF_3D_Topology **, DM);
