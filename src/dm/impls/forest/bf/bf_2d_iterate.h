...
PetscErrorCode DMBF_2D_IterateSetCellFields(DM, DM_BF_Cell *, size_t, size_t, size_t, const PetscInt *, PetscInt, const PetscInt *, PetscInt, Vec *, Vec *, PetscInt, PetscInt *, PetscInt, PetscInt *);
...
PetscErrorCode DMBF_2D_IterateGetCellFields(DM, DM_BF_Cell *, size_t, size_t, size_t, const PetscInt *, PetscInt, const PetscInt *, PetscInt, Vec *, Vec *, PetscInt, PetscInt *, PetscInt, PetscInt *);
