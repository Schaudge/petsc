...
!     Create a mesh
      call DMPlexCreateBoxMesh(PETSC_COMM_WORLD, dim, PETSC_TRUE, [PETSC_NULL_INTEGER,PETSC_NULL_INTEGER], PETSC_NULL_REAL, PETSC_NULL_REAL, PETSC_NULL_INTEGER, interpolate, dm, ierr);CHKERRA(ierr)
