...
/*TEST
  ...
  testset:
    ...
    test:
      ...
      args: -dm_plex_boundary_filename ${wPETSC_DIR}/share/petsc/datafiles/meshes/sphere_example.egadslite
    ...
    test:
      suffix: sphere_egads
      args: -dm_plex_boundary_filename ${wPETSC_DIR}/share/petsc/datafiles/meshes/sphere_example.egads

    test:
      suffix: cylinder_egads
      args: -dm_plex_boundary_filename ${wPETSC_DIR}/share/petsc/datafiles/meshes/cylinder_example.egads

    test:
      suffix: cylinder_igs
      args: -dm_plex_boundary_filename ${wPETSC_DIR}/share/petsc/datafiles/meshes/cylinder_example.igs
    ...
    test:
      suffix: nozzle_stp
      args: -dm_plex_boundary_filename ${wPETSC_DIR}/share/petsc/datafiles/meshes/nozzle_example.stp
    ...
    test:
      suffix: nozzle_igs
      args: -dm_plex_boundary_filename ${wPETSC_DIR}/share/petsc/datafiles/meshes/nozzle_example.igs
