...
/*@
  DMPlexCreateCellColoring - create a coloring of cells using a distance one coloring of the cell or dual graph of a matrix for shared memory assembly

  Collective on JacP

  Input Parameters:
+   JacP  - matrix that is to be assembled, generated by the DM (created in serial in DMPlex)
.   plex - The DM
