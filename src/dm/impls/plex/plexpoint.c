...
.seealso: DMPlexGetPointLocalField(), DMGetLocalSection(), PetscSectionGetOffset(), PetscSectionGetCount(), DMPlexPointLocalRead(), DMPlexPointLocalRead(), DMPlexPointLocalRef()
@*/
...
.seealso: DMGetLocalSection(), PetscSectionGetOffset(), PetscSectionGetCount(), DMPlexGetPointLocal(), DMPlexPointGlobalRead()
@*/
...
.seealso: DMGetLocalSection(), PetscSectionGetOffset(), PetscSectionGetCount(), DMPlexGetPointLocal(), DMPlexPointGlobalRef()
@*/
...
.seealso: DMPlexGetPointLocal(), DMGetLocalSection(), PetscSectionGetOffset(), PetscSectionGetCount(), DMPlexPointLocalRead(), DMPlexPointLocalRead(), DMPlexPointLocalRef()
@*/
...
.seealso: DMPlexGetPointGlobalField(), DMGetLocalSection(), PetscSectionGetOffset(), PetscSectionGetCount(), DMPlexPointGlobalRead(), DMPlexGetPointLocal(), DMPlexPointGlobalRead(), DMPlexPointGlobalRef()
@*/
...
.seealso: DMGetLocalSection(), PetscSectionGetOffset(), PetscSectionGetCount(), DMPlexGetPointGlobal(), DMPlexPointLocalRead(), DMPlexPointGlobalRef()
@*/
...
.seealso: DMGetLocalSection(), PetscSectionGetOffset(), PetscSectionGetCount(), DMPlexGetPointGlobal(), DMPlexPointLocalRef(), DMPlexPointGlobalRead()
@*/
...
.seealso: DMPlexGetPointGlobal(), DMGetLocalSection(), PetscSectionGetOffset(), PetscSectionGetCount(), DMPlexPointGlobalRead(), DMPlexGetPointLocal(), DMPlexPointGlobalRead(), DMPlexPointGlobalRef()
@*/
