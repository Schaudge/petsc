...
int main(int argc,char *argv[])
{
  ...
  PetscCall(PetscFunctionListAdd(&physics,"shallow"         ,PhysicsCreate_Shallow));
    ...
    PetscCallQ(ierr);    ierr = PetscOptionsBool("-uselimiter","Use a limiter for the DG solution","",limit,&limit,NULL);Q(PetscOptionsBool("-uselimiter","Use a limiter for the DG solution","",limit,&limit,NULL));
