...
%!rm -rf Summit-Mesh-Performance/Data/Run32/
%!mkdir Summit-Mesh-Performance/Data/Run32/
%!cp -r Summit-Mesh-Performance/Data/DEBUG_32* Summit-Mesh-Performance/Data/Run32/
%!./grepshell.sh -a Summit-Mesh-Performance/Data/Run32/DEBUG*/rawlog_*
datadir = 'Summit-Mesh-Performance/Data/Run32/';
...
for k=1:numfolder
    ...
    SFPADDVALL(i,:) = transpose(load(sfpAF.name));
    SFUPADDVALL(i,:) = transpose(load(sfupAF.name));
    
    i = i + 1;
    cd(folders(i).folder);
end
clear foAF foIF npF psAF psIF cprF vnF cnF oF vdTF  sfpIF sfupIf sfpAF sfupAF
