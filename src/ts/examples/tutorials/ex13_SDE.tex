...
\begin{figure}
\centering
\includegraphics{/Users/luminche/soft/petsc/src/ts/examples/tutorials/plot.gif}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{/Users/luminche/soft/petsc/src/ts/examples/tutorials/SepExp_sigma=1.5,Lx=0.1,Ly=0.1.gif}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{/Users/luminche/soft/petsc/src/ts/examples/tutorials/Exp_sigma=1.5,Lc=2.gif}
\caption{}
\end{figure}
