...
/*@C
   DMDASNESSetFunctionLocalVec - set a local residual evaluation function with extension
...
/*@C
   DMDASNESSetJacobianLocalVec - set a local Jacobian evaluation function with extension
...
/*@C
   DMDASNESSetObjectiveLocal - set a local residual evaluation function with extension
