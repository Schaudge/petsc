...
/*@C
  SNESFinalizePackage - Destroys everything in the Petsc interface to the SNES package. It is
...
/*@C
  SNESInitializePackage - Initializes everything in the SNES package. It is called
