...
/*TEST
   ...
   test:
      ...
      nsize: 1
      requires: cuda
      args: -snes_monitor -dm_mat_type seqaijcusparse -dm_vec_type seqcuda -pc_type gamg -pc_gamg_esteig_ksp_max_it 10 -ksp_monitor -mg_levels_ksp_max_it 1 -pc_gamg_mis_k_minimum_degree_ordering true

   test:
      suffix: cuda_2
      nsize: 3
      requires: cuda !single
      args: -snes_monitor -dm_mat_type mpiaijcusparse -dm_vec_type mpicuda -pc_type gamg -pc_gamg_esteig_ksp_max_it 10 -ksp_monitor  -mg_levels_ksp_max_it 1 -pc_gamg_mis_k_minimum_degree_ordering true
