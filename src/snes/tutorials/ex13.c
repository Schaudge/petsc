...
/*TEST
  ...
  test:
    # Using -dm_refine 2 -convest_num_refine 3 we get L_2 convergence rate: 1.9
    suffix: 2d_p1_conv_self_homogeneous
    requires: triangle
    args: -potential_petscspace_degree 1 -snes_convergence_estimate -snes_convergence_estimate_self -convest_num_refine 5 -convest_monitor -homogeneous
  test:
  ...
  test:
    ...
    args: -potential_petscspace_degree 1 -snes_type fas -fas_coarse_snes_monitor \
      -fas_levels_snes_monitor -snes_monitor -dm_refine_hierarchy 5 -snes_fas_levels 5 -snes_fas_type full \
      -snes_max_it 1 -fas_levels_snes_type newtonls -fas_levels_snes_atol 1.e-13 -fas_coarse_snes_atol 1.e-13 \
      -fas_levels_snes_max_it 1 -fas_levels_ksp_atol 1.e-13 -fas_coarse_ksp_atol 1.e-13
  test:
    suffix: 2d_p1_fas_full_homogeneous
    args: -potential_petscspace_degree 1 -snes_type fas -fas_coarse_snes_monitor \
      -fas_levels_snes_monitor -snes_monitor -dm_refine_hierarchy 5 -snes_fas_levels 5 -snes_fas_type full \
      -snes_max_it 1 -fas_levels_snes_type newtonls -fas_levels_snes_atol 1.e-13 -fas_coarse_snes_atol 1.e-13 \
      -fas_levels_snes_max_it 1 -fas_levels_ksp_atol 1.e-13 -fas_coarse_ksp_atol 1.e-13 -homogeneous
