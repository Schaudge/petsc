...
{
  return AYPXAsync(yin, alpha, xin, nullptr);
}
...
{
  return AXPYAsync(yin, alpha, xin, nullptr);
}
...
{
  return PointwiseDivideAsync(wout, xin, yin, nullptr);
}
...
{
  return PointwiseMultAsync(wout, xin, yin, nullptr);
}
...
{
  return PointwiseMaxAsync(wout, xin, yin, nullptr);
}
...
{
  return PointwiseMaxAbsAsync(wout, xin, yin, nullptr);
}
...
{
  return PointwiseMinAsync(wout, xin, yin, nullptr);
}
...
{
  return ReciprocalAsync(xin, nullptr);
}
...
{
  return SqrtAbsAsync(xin, nullptr);
}
...
{
  return WAXPYAsync(win, alpha, xin, yin, nullptr);
}
...
{
  return MAXPYAsync(xin, nv, alpha, yin, nullptr);
}
...
{
  return SetAsync(xin, alpha, nullptr);
}
...
{
  return ScaleAsync(xin, alpha, nullptr);
}
...
{
  return CopyAsync(xin, yout, nullptr);
}
...
{
  return SwapAsync(xin, yin, nullptr);
}
...
{
  return AXPBYAsync(yin, alpha, beta, xin, nullptr);
}
...
{
  return AXPBYPCZAsync(zin, alpha, beta, gamma, xin, yin, nullptr);
}
...
{
  return ConjugateAsync(xin, nullptr);
}
...
{
  return ShiftAsync(v, shift, nullptr);
}
