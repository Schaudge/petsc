...
private:
  PETSC_NODISCARD static Vec_Seq *VecIMPLCast_(Vec v) noexcept { return static_cast<Vec_Seq *>(v->data); }

  PETSC_NODISCARD static constexpr VecType VECTYPE_() noexcept { return VECSEQCUPM(); }

  // common core for min and max
  template <typename TupleFuncT, typename UnaryFuncT>
  PETSC_NODISCARD static PetscErrorCode minmax_async_(TupleFuncT &&, UnaryFuncT &&, PetscReal, Vec, ManagedInt &, ManagedReal &, PetscDeviceContext) noexcept;
  // common core for pointwise binary and pointwise unary thrust functions
  template <typename BinaryFuncT>
  PETSC_NODISCARD static PetscErrorCode pointwisebinary_async_(BinaryFuncT &&, PetscDeviceContext, Vec, Vec, Vec) noexcept;
  template <typename UnaryFuncT>
  PETSC_NODISCARD static PetscErrorCode pointwiseunary_async_(UnaryFuncT &&, PetscDeviceContext, Vec, Vec /*out*/ = nullptr) noexcept;
  // mdot dispatchers
  PETSC_NODISCARD static PetscErrorCode mdot_async_(UseComplexTag<true>, Vec, PetscInt, const Vec[], ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode mdot_async_(UseComplexTag<false>, Vec, PetscInt, const Vec[], ManagedScalar &, PetscDeviceContext) noexcept;
  ...
  PETSC_NODISCARD static PetscErrorCode createseqcupm_async_(Vec, PetscDeviceContext, PetscScalar * /*host_ptr*/ = nullptr, PetscScalar * /*device_ptr*/ = nullptr) noexcept;

public:
  // callable directly via a bespoke function
  PETSC_NODISCARD static PetscErrorCode create_async(Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode createseqcupm_async(MPI_Comm, PetscInt, PetscInt, PetscDeviceContext, Vec *, PetscBool) noexcept;
  PETSC_NODISCARD static PetscErrorCode createseqcupmwithbotharrays_async(MPI_Comm, PetscInt, PetscInt, const PetscScalar[], const PetscScalar[], PetscDeviceContext, Vec *) noexcept;

  // callable indirectly via function pointers
  PETSC_NODISCARD static PetscErrorCode duplicate_async(Vec, Vec *, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode aypx_async(Vec, ManagedScalar &, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode axpy_async(Vec, ManagedScalar &, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode pointwisedivide_async(Vec, Vec, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode pointwisemult_async(Vec, Vec, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode reciprocal_async(Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode waxpy_async(Vec, ManagedScalar &, Vec, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode maxpy_async(Vec, ManagedInt &, ManagedScalar &, Vec *, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode dot_async(Vec, Vec, ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode mdot_async(Vec, ManagedInt &, const Vec[], ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode set_async(Vec, ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode scale_async(Vec, ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode tdot_async(Vec, Vec, ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode copy_async(Vec, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode swap_async(Vec, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode axpby_async(Vec, ManagedScalar &, ManagedScalar &, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode axpbypcz_async(Vec, ManagedScalar &, ManagedScalar &, ManagedScalar &, Vec, Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode norm_async(Vec, NormType, ManagedReal &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode dotnorm2_async(Vec, Vec, ManagedScalar &, ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode destroy_async(Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode conjugate_async(Vec, PetscDeviceContext) noexcept;
  template <PetscMemoryAccessMode>
  PETSC_NODISCARD static PetscErrorCode getlocalvector_async(Vec, Vec, PetscDeviceContext) noexcept;
  template <PetscMemoryAccessMode>
  PETSC_NODISCARD static PetscErrorCode restorelocalvector_async(Vec, Vec, PetscDeviceContext) noexcept;
  template <PetscMemType>
  PETSC_NODISCARD static PetscErrorCode resetarray_async(Vec, PetscDeviceContext) noexcept;
  template <PetscMemType>
  PETSC_NODISCARD static PetscErrorCode placearray_async(Vec, const PetscScalar *, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode max_async(Vec, ManagedInt &, ManagedReal &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode min_async(Vec, ManagedInt &, ManagedReal &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode sum_async(Vec, ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode shift_async(Vec, ManagedScalar &, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode setrandom_async(Vec, PetscRandom, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode bindtocpu_async(Vec, PetscBool, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode setpreallocationcoo_async(Vec, PetscCount, const PetscInt[], PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode setvaluescoo_async(Vec, const PetscScalar[], InsertMode, PetscDeviceContext) noexcept;
};
...
struct complex_one {
  ...
  constexpr complex_one() noexcept = default;
};
// REVIEW ME:
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::aypx_async(Vec yin, ManagedScalar &alpha, Vec xin, PetscDeviceContext dctx)) {
  ...
  if (alpha[0] == 0.0) {
    ...
    const auto       alphaIsOne = alpha[0] == 1.0;
    cupmBlasHandle_t cupmBlasHandle;
    const auto       aptr = alpha.device_cbegin(dctx).to_pointer();

    //PetscCall(alpha.get_array(dctx, PETSC_MEMTYPE_DEVICE, PETSC_MEMORY_ACCESS_READ, PETSC_FALSE, &aptr));
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::axpy_async(Vec yin, ManagedScalar &alpha, Vec xin, PetscDeviceContext dctx)) {
  PetscBool xiscupm;
  ...
  if (xiscupm) {
    ...
    PetscCall(VecAXPY_Seq(yin, *alpha.host_begin(dctx, PETSC_TRUE), xin));
  }
  PetscFunctionReturn(0);
}
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::waxpy_async(Vec win, ManagedScalar &alpha, Vec xin, Vec yin, PetscDeviceContext dctx)) {
  PetscFunctionBegin;
  if (PetscManagedScalarKnownAndEqual(alpha, 0.0)) {
    ...
    const auto       aptr = cupmScalarCast(alpha.device_cbegin(dctx).to_pointer());
    cupmBlasHandle_t cupmBlasHandle;
    cupmStream_t     stream;
    ...
    PetscCall(GetHandles_(dctx, &cupmBlasHandle, &stream));
    {
      ...
      PetscCallCUPMBLAS(cupmBlasXaxpy(cupmBlasHandle, n, aptr, DeviceArrayRead(dctx, xin), 1, wptr.cupmdata(), 1));
      PetscCall(PetscLogGpuTimeEnd());
    }
    PetscCall(PetscLogGpuFlops(2 * n));
  }
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::maxpy_async(Vec xin, ManagedInt &nv, ManagedScalar &alpha, Vec *yin, PetscDeviceContext dctx)) {
  const auto   n     = xin->map->n;
  const auto   xptr  = DeviceArrayReadWrite(dctx, xin);
  const auto   aptr  = alpha.device_cbegin(dctx).to_pointer();
  const auto   nvval = *nv.host_cbegin(dctx, PETSC_TRUE);
  PetscInt     yidx  = 0;
  cupmStream_t stream;
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::dot_async(Vec xin, Vec yin, ManagedScalar &z, PetscDeviceContext dctx)) {
  const auto       n    = xin->map->n;
  const auto       zptr = cupmScalarCast(z.device_begin(dctx, PETSC_MEMORY_ACCESS_WRITE).to_pointer());
  cupmBlasHandle_t cupmBlasHandle;
  ...
  PetscCall(GetHandles_(dctx, &cupmBlasHandle));
  {
    ...
    // second
    PetscCall(PetscLogGpuTimeBegin());
    PetscCallCUPMBLAS(cupmBlasXdot(cupmBlasHandle, n, DeviceArrayRead(dctx, yin), 1, DeviceArrayRead(dctx, xin), 1, zptr));
    PetscCall(PetscLogGpuTimeEnd());
  }
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::mdot_async_(UseComplexTag<false>, Vec xin, PetscInt nv, const Vec yin[], ManagedScalar &z, PetscDeviceContext dctx)) {
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::mdot_async_(UseComplexTag<true>, Vec xin, PetscInt nv, const Vec yin[], ManagedScalar &z, PetscDeviceContext dctx)) {
  ...
  const auto          xptr  = DeviceArrayRead(dctx, xin);
  const auto          zptr  = z.device_begin(dctx, PETSC_MEMORY_ACCESS_WRITE);
  PetscDeviceContext *subctx;

  PetscFunctionBegin;
  PetscCall(PetscLogGpuTimeBegin());
  PetscCall(PetscDeviceContextFork(dctx, n_sub, &subctx));
  for (PetscInt i = 0; i < nv; ++i, ++zptr) {
    ...
    PetscCall(GetHandles_(sub, &handle));
    {
      ...
      PetscCallCUPMBLAS(cupmBlasXdot(handle, n, DeviceArrayRead(sub, yin[i]), 1, xptr.cupmdata(), 1, cupmScalarCast(zptr.to_pointer())));
    }
  }
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::mdot_async(Vec xin, ManagedInt &nv, const Vec yin[], ManagedScalar &z, PetscDeviceContext dctx)) {
  PetscFunctionBegin;
  if (PetscUnlikely(PetscManagedIntKnownAndEqual(nv, 1))) {
    ...
    PetscCheck(nvval > 0, PETSC_COMM_SELF, PETSC_ERR_LIB, "Number of vectors provided to %s %" PetscInt_FMT " not positive", PETSC_FUNCTION_NAME, nvval);

    PetscCall(mdot_async_(UseComplexTag<PetscDefined(USE_COMPLEX)>{}, xin, nvval, yin, z, dctx));
    // REVIEW ME: double count of flops??
    PetscCall(PetscLogGpuFlops(PetscMax(nvval * (2 * n - 1), 0)));
  } else {
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::set_async(Vec xin, ManagedScalar &alpha, PetscDeviceContext dctx)) {
  const auto   n    = xin->map->n;
  ...
  if (PetscManagedScalarKnownAndEqual(alpha, 0.0)) {
    ...
    PetscCall(alpha.get_array_and_memtype(dctx, PETSC_MEMORY_ACCESS_READ, &ptr, &mtype));
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::scale_async(Vec xin, ManagedScalar &alpha, PetscDeviceContext dctx)) {
  PetscFunctionBegin;
  ...
  if (PetscManagedScalarKnownAndEqual(alpha, 0.0)) {
    ...
    PetscCall(GetHandles_(dctx, &cupmBlasHandle));
    {
      const auto cmode = WithCUPMBlasPointerMode<T>{cupmBlasHandle, PETSC_MEMTYPE_DEVICE};

      PetscCall(PetscLogGpuTimeBegin());
      PetscCallCUPMBLAS(cupmBlasXscal(cupmBlasHandle, n, aptr, DeviceArrayReadWrite(dctx, xin), 1));
      PetscCall(PetscLogGpuTimeEnd());
    }
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::tdot_async(Vec xin, Vec yin, ManagedScalar &z, PetscDeviceContext dctx)) {
  const auto       n    = static_cast<cupmBlasInt_t>(xin->map->n);
  const auto       zptr = cupmScalarCast(z.device_begin(dctx, PETSC_MEMORY_ACCESS_WRITE).to_pointer());
  cupmBlasHandle_t cupmBlasHandle;
  ...
  PetscCall(GetHandles_(dctx, &cupmBlasHandle));
  {
    ...
    PetscCall(PetscLogGpuTimeBegin());
    PetscCallCUPMBLAS(cupmBlasXdotu(cupmBlasHandle, n, DeviceArrayRead(dctx, xin), 1, DeviceArrayRead(dctx, yin), 1, zptr));
    PetscCall(PetscLogGpuTimeEnd());
  }
  PetscCall(PetscLogGpuFlops(PetscMax(2 * n - 1, 0)));
  PetscFunctionReturn(0);
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::axpby_async(Vec yin, ManagedScalar &alpha, ManagedScalar &beta, Vec xin, PetscDeviceContext dctx)) {
  PetscFunctionBegin;
  if (PetscManagedScalarKnownAndEqual(alpha, 0.0)) {
  ...
  if (PetscManagedScalarKnownAndEqual(alpha, 1.0)) {
    ...
    const auto       bzero = ManagedScalar & KnownAndEqual(beta, 0.0);
    const auto       n     = static_cast<cupmBlasInt_t>(yin->map->n);
    const auto       xptr  = DeviceArrayRead(dctx, xin);
    const auto       aptr  = cupmScalarCast(alpha.device_cbegin(dctx).to_pointer());
    cupmBlasHandle_t cupmBlasHandle;
    ...
    PetscCall(GetHandles_(dctx, &cupmBlasHandle));
    {
      ...
      if (bzero /* beta = 0 */) {
        ...
        const auto   yptr = DeviceArrayReadWrite(dctx, yin);
        const auto   bptr = cupmScalarCast(beta.device_cbegin(dctx).to_pointer());
        PetscScalar *bptr;

        PetscCall(PetscLogGpuTimeBegin());
        PetscCallCUPMBLAS(cupmBlasXscal(cupmBlasHandle, n, bptr, yptr.cupmdata(), 1));
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::axpbypcz_async(Vec zin, ManagedScalar &alpha, ManagedScalar &beta, ManagedScalar &gamma, Vec xin, Vec yin, PetscDeviceContext dctx)) {
  PetscFunctionBegin;
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::norm_async(Vec xin, NormType type, ManagedReal &z, PetscDeviceContext dctx)) {
  PetscFunctionBegin;
  if (const auto n = static_cast<cupmBlasInt_t>(xin->map->n)) {
    const auto       xptr      = DeviceArrayRead(dctx, xin);
    auto             zptr      = z.device_begin(dctx, PETSC_MEMORY_ACCESS_WRITE);
    ...
    case NORM_1_AND_2:
    case NORM_1:
      PetscCallCUPMBLAS(cupmBlasXasum(cupmBlasHandle, n, xptr.cupmdata(), 1, cupmRealCast(zptr.to_pointer())));
      flopCount = PetscMax(n - 1, 0);
      if (type == NORM_1) break;
      ++zptr; // fall-through
    case NORM_2:
    case NORM_FROBENIUS:
      PetscCallCUPMBLAS(cupmBlasXnrm2(cupmBlasHandle, n, xptr.cupmdata(), 1, cupmRealCast(zptr.to_pointer())));
      flopCount += PetscMax(2 * n - 1, 0); // += in case we've fallen through from NORM_1_AND_2
      break;
    case NORM_INFINITY: {
      cupmStream_t stream;
      ManagedInt   iscal(dctx, 1);
      const auto   iptr = iscal.device_begin(dctx, PETSC_MEMORY_ACCESS_WRITE).to_pointer();

      PetscCall(GetHandles_(dctx, &stream));
      PetscCallCUPMBLAS(cupmBlasXamax(cupmBlasHandle, n, xptr.cupmdata(), 1, i_ptr));
      PetscCall(PetscCUPMLaunchKernel1D(1, 0, stream, kernels::norm_infinity, xptr.data(), zptr.to_pointer(), i_ptr));
      // REVIEW ME: flopCount = ???
    } break;
    }
    PetscCall(PetscLogGpuTimeEnd());
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::dotnorm2_async(Vec s, Vec t, ManagedScalar &dp, ManagedScalar &nm, PetscDeviceContext dctx)) {
...
struct real_part {
  PETSC_HOSTDEVICE_INLINE_DECL thrust::tuple<PetscReal, PetscInt> operator()(const thrust::tuple<PetscScalar, PetscInt> &x) const { return thrust::make_tuple(PetscRealPart(x.get<0>()), x.get<1>()); }
...
template <device::cupm::DeviceType T>
template <typename TupleFuncT, typename UnaryFuncT>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::minmax_async_(TupleFuncT &&tuple_ftr, UnaryFuncT &&unary_ftr, PetscReal mval, Vec v, ManagedInt &p, ManagedReal &m, PetscDeviceContext dctx)) {
  PetscFunctionBegin;
  PetscCheckTypeNames(v, VECSEQCUPM(), VECMPICUPM());
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::max_async(Vec v, ManagedInt &p, ManagedReal &m, PetscDeviceContext dctx)) {
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::min_async(Vec v, ManagedInt &p, ManagedReal &m, PetscDeviceContext dctx)) {
  using value_type    = util::remove_pointer_t<decltype(m->device)>;
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::sum_async(Vec v, ManagedScalar &sum, PetscDeviceContext dctx)) {
...
template <device::cupm::DeviceType T>
PETSC_CXX_COMPAT_DEFN(PetscErrorCode VecSeq_CUPM<T>::shift_async(Vec v, ManagedScalar &shift, PetscDeviceContext dctx)) {
  PetscScalar *ptr;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCreateSeqCUPMAsync(T &&VecSeq_CUPM_Impls, MPI_Comm comm, PetscInt n, PetscDeviceContext dctx, Vec *v) noexcept {
  PetscFunctionBegin;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCreateSeqCUPMWithArraysAsync(T &&VecSeq_CUPM_Impls, MPI_Comm comm, PetscInt bs, PetscInt n, const PetscScalar cpuarray[], const PetscScalar gpuarray[], PetscDeviceContext dctx, Vec *v) noexcept {
  PetscFunctionBegin;
...
PETSC_NODISCARD inline PetscErrorCode VecCUPMGetArrayAsync_Private(T &&VecSeq_CUPM_Impls, Vec v, PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <PetscMemoryAccessMode mode, typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMRestoreArrayAsync_Private(T &&VecSeq_CUPM_Impls, Vec v, PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
  PetscValidHeaderSpecific(v, VEC_CLASSID, 2);
  PetscCall(PetscDeviceContextGetOptionalNullContext_Internal(&dctx));
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMGetArrayAsync(T &&VecSeq_CUPM_Impls, Vec v, PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMRestoreArrayAsync(T &&VecSeq_CUPM_Impls, Vec v, PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMGetArrayReadAsync(T &&VecSeq_CUPM_Impls, Vec v, const PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMRestoreArrayReadAsync(T &&VecSeq_CUPM_Impls, Vec v, const PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMGetArrayWriteAsync(T &&VecSeq_CUPM_Impls, Vec v, PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMRestoreArrayWriteAsync(T &&VecSeq_CUPM_Impls, Vec v, PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMPlaceArrayAsync(T &&VecSeq_CUPM_Impls, Vec vin, const PetscScalar a[], PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMReplaceArrayAsync(T &&VecSeq_CUPM_Impls, Vec vin, const PetscScalar a[], PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
  PetscValidHeaderSpecific(vin, VEC_CLASSID, 2);
  PetscCall(PetscDeviceContextGetOptionalNullContext_Internal(&dctx));
...
template <typename T>
PETSC_NODISCARD inline PetscErrorCode VecCUPMResetArrayAsync(T &&VecSeq_CUPM_Impls, Vec vin, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
  PetscValidHeaderSpecific(vin, VEC_CLASSID, 2);
  PetscCall(PetscDeviceContextGetOptionalNullContext_Internal(&dctx));
