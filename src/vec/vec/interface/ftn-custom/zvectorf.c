...
PETSC_EXTERN void PETSC_STDCALL  vecgetvalues_(Vec *x,PetscInt *ni, PetscInt ix[], PetscScalar y[],int *ierr )
{
  *ierr = VecGetValues(*x,*ni,ix,y);
}

PETSC_EXTERN void PETSC_STDCALL  vecgetvalues0_(Vec *x,PetscInt *ni, PetscInt ix[], PetscScalar y[],int *ierr )
{
  vecgetvalues_(x,ni,ix,y,ierr);
}

PETSC_EXTERN void PETSC_STDCALL  vecgetvalues1_(Vec *x,PetscInt *ni, PetscInt ix[], PetscScalar y[],int *ierr )
{
  vecgetvalues_(x,ni,ix,y,ierr);
}

PETSC_EXTERN void PETSC_STDCALL  vecgetvalues11_(Vec *x,PetscInt *ni, PetscInt ix[], PetscScalar y[],int *ierr )
{
  vecgetvalues_(x,ni,ix,y,ierr);
}
