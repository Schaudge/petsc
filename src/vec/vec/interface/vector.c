...
{
  PetscErrorCode    ierr;
  PetscBool         isbinary,ishdf5,isadios,isadios2,isexodusii;
  PetscViewerFormat format;
  ...
  if (!isbinary && !ishdf5 && !isadios && !isadios2 & !isexodusii) SETERRQ(PETSC_COMM_SELF,PETSC_ERR_ARG_WRONG,"Invalid viewer; open viewer with PetscViewerBinaryOpen()");
