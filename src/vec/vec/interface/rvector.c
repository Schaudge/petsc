...
{
  return VecScaleAsync_Private(x, alpha, NULL);
}
...
{
  return VecSetAsync_Private(x, alpha, NULL);
}
...
{
  return VecAXPYAsync_Private(y, alpha, x, NULL);
}
...
{
  return VecAYPXAsync_Private(y, beta, x, NULL);
}
...
{
  return VecAXPBYAsync_Private(y, alpha, beta, x, NULL);
}
...
{
  return VecAXPBYPCZAsync_Private(z, alpha, beta, gamma, x, y, NULL);
}
...
{
  return VecWAXPYAsync_Private(w, alpha, x, y, NULL);
}
...
{
  return VecMAXPYAsync_Private(y, nv, alpha, x, NULL);
}
