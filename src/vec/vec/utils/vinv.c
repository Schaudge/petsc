...
{
  return VecExpAsync_Private(v, NULL);
}
...
{
  return VecLogAsync_Private(v, NULL);
}
...
{
  return VecAbsAsync_Private(v, NULL);
}
...
{
  return VecConjugateAsync_Private(x, NULL);
}
...
{
  return VecSqrtAbsAsync_Private(v, NULL);
}
...
{
  return VecShiftAsync_Private(v, shift, NULL);
}
