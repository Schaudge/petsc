...
PETSC_EXTERN PetscErrorCode PetscFEIntegrateResidual(PetscDS, PetscDS, PetscFormKey, PetscInt, PetscFEGeom *, const PetscScalar[], const PetscScalar[], PetscDS, const PetscScalar[], PetscReal, PetscScalar[]);
