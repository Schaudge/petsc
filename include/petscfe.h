...
PETSC_EXTERN PetscErrorCode PetscSpaceSumSetOrthogonal(PetscSpace, PetscBool);
PETSC_EXTERN PetscErrorCode PetscSpaceSumGetOrthogonal(PetscSpace, PetscBool *);
