...
=======
PETSC_EXTERN PetscErrorCode DMNetworkGetGlobalNumberOfVertices(DM,PetscInt *); 
>>>>>>> Added DMNetworkGetGlobalNumberOfVertices, missing access function for DMNetwork
