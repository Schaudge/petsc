...
PETSC_EXTERN PetscErrorCode TaoComputeFixedPoint(Tao, Vec, Vec, PetscReal, Mat);
...
PETSC_EXTERN PetscErrorCode TaoFBSetNonSmoothTermWithLinearMap(Tao, DM, Mat);
...
PETSC_EXTERN PetscErrorCode DMTaoApplyProximalMap(DM, DM, PetscReal, Vec, Vec, PetscBool, void *);
...
PETSC_EXTERN PetscErrorCode DMTaoCreate_L1(MPI_Comm, DM *, Mat, Vec, PetscReal, PetscReal);
