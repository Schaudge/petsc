...
PETSC_EXTERN PetscErrorCode TSMonitorSpeed(TS, PetscInt, PetscReal, Vec, PetscViewerAndFormat *);
PETSC_EXTERN PetscErrorCode TSMonitorSpeedSetUp(TS, PetscViewerAndFormat *);
