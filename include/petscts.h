...
PETSC_EXTERN PETSC_DEPRECATED_FUNCTION("RHSJacobian is always reusable now") PetscErrorCode TSRHSJacobianSetReuse(TS,PetscBool);
...
PETSC_EXTERN PetscErrorCode TSRecoverRHSJacobian(TS,Mat,Mat);
