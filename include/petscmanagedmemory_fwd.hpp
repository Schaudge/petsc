...
PETSC_NODISCARD PETSC_CXX_EXTERN const ManagedScalar &MANAGED_REAL_ONE() noexcept;
PETSC_NODISCARD PETSC_CXX_EXTERN const ManagedScalar &MANAGED_SCAL_ZERO() noexcept;
PETSC_NODISCARD PETSC_CXX_EXTERN const ManagedScalar &MANAGED_REAL_ZERO() noexcept;
