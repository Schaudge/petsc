...
$ PETSCSPACE_POLYNOMIALTYPE_WHEELER - This is a quadratic enrichment with divergence zero intended for prisms

  Level: beginner

.seealso: PetscSpace
M*/
typedef enum { PETSCSPACE_POLYNOMIALTYPE_P, PETSCSPACE_POLYNOMIALTYPE_PMINUS_HDIV, PETSCSPACE_POLYNOMIALTYPE_PMINUS_HCURL, PETSCSPACE_POLYNOMIALTYPE_WHEELER } PetscSpacePolynomialType;
