...
/*MC
  ...
  Notes:
    This is used only for automatic creation of reference cells. A PetscDualSpace can accept an arbitary DM for a reference cell.
...
$ Contravariant Piola: $\sigma^*(F) = 1/|J| J F \circ \phi^{-1)$
  ...
  Note:
    For details, please see Rognes, Kirby, and Logg, Efficient Assembly of Hdiv and Hrot Conforming Finite Elements, SISC, 31(6), 4130-4151, arXiv 1205.3085, 2010
