...
PETSC_EXTERN PetscErrorCode PetscFnDerivativeFn(PetscFn,PetscInt,PetscInt,PetscInt,const IS[], const Vec[],PetscFn *);
...
PETSC_EXTERN PetscErrorCode PetscFnScalarDerivativeFn(PetscFn,PetscInt,PetscInt,const IS[], const Vec[],PetscFn *);
