...
PETSC_EXTERN PetscErrorCode PetscInfo_Private(int,const char[],const char[],PetscObject,const char[],...);
#if defined(PETSC_USE_INFO)
#define PetscInfo(A,S)                             PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S)
#define PetscInfo1(A,S,a1)                         PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1)
#define PetscInfo2(A,S,a1,a2)                      PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1,a2)
#define PetscInfo3(A,S,a1,a2,a3)                   PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1,a2,a3)
#define PetscInfo4(A,S,a1,a2,a3,a4)                PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1,a2,a3,a4)
#define PetscInfo5(A,S,a1,a2,a3,a4,a5)             PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1,a2,a3,a4,a5)
#define PetscInfo6(A,S,a1,a2,a3,a4,a5,a6)          PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1,a2,a3,a4,a5,a6)
#define PetscInfo7(A,S,a1,a2,a3,a4,a5,a6,a7)       PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1,a2,a3,a4,a5,a6,a7)
#define PetscInfo8(A,S,a1,a2,a3,a4,a5,a6,a7,a8)    PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1,a2,a3,a4,a5,a6,a7,a8)
#define PetscInfo9(A,S,a1,a2,a3,a4,a5,a6,a7,a8,a9) PetscInfo_Private(__LINE__,PETSC_FUNCTION_NAME,PETSC_BASE_FILE_NAME,((PetscObject)A),S,a1,a2,a3,a4,a5,a6,a7,a8,a9)
#else
