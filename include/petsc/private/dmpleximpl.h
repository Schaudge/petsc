...
PETSC_INTERN PetscErrorCode DMLoad_Plex_CGNS_Internal(DM, PetscInt, PetscBool);
...
PETSC_INTERN PetscErrorCode DMPlexVecGetOrientedClosure_Internal(DM, PetscSection, Vec, PetscInt, PetscInt, PetscInt *, PetscScalar *[]);
