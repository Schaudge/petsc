...
class WithCUPMBlasPointerMode : public device::cupm::impl::BlasInterface<T> {
  ...
  static cupmBlasPointerMode_t get_old_mode(const cupmBlasHandle_t &handle) noexcept {
    ...
    PetscFunctionBegin;
    PetscCallCUPMBLASAbort(PETSC_COMM_SELF, cupmBlasGetPointerMode(handle, &mode));
...
public:
  ...
  ~WithCUPMBlasPointerMode() noexcept {
    ...
    PetscCallCUPMBLASAbort(PETSC_COMM_SELF, cupmBlasSetPointerMode(handle_, mode_));
    PetscFunctionReturnVoid();
  }
...
private:
  ...
  PETSC_NODISCARD static PetscErrorCode GetHandleDispatch_(PetscDeviceContext dctx, cupmBlasHandle_t *handle, cupmStream_t *stream) noexcept {
    PetscFunctionBegin;
  ...
  private:
    ...
    PETSC_NODISCARD static pointer_type initialize_(PetscDeviceContext dctx, Vec v) noexcept {
...
protected:
  ...
  PETSC_NODISCARD static PetscErrorCode GetHandles_(PetscDeviceContext dctx, cupmBlasHandle_t *handle, cupmStream_t *stream = nullptr) noexcept { return GetHandleDispatch_(dctx, handle, stream); }

  PETSC_NODISCARD static PetscErrorCode GetHandles_(PetscDeviceContext dctx, cupmStream_t *stream) noexcept { return GetHandleDispatch_(dctx, nullptr, stream); }
...
public:
  ...
  PETSC_NODISCARD static constexpr Vec_CUPM *VecCUPMCast(Vec v) noexcept { return static_cast<Vec_CUPM *>(v->spptr); }
  ...
  PETSC_NODISCARD static constexpr auto VecIMPLCast(Vec v) noexcept PETSC_DECLTYPE_AUTO_RETURNS(U::VecIMPLCast_(v));

  PETSC_NODISCARD static constexpr PetscLogEvent VEC_CUPMCopyToGPU() noexcept { return T == device::cupm::DeviceType::CUDA ? VEC_CUDACopyToGPU : VEC_HIPCopyToGPU; }

  PETSC_NODISCARD static constexpr PetscLogEvent VEC_CUPMCopyFromGPU() noexcept { return T == device::cupm::DeviceType::CUDA ? VEC_CUDACopyFromGPU : VEC_HIPCopyFromGPU; }

  PETSC_NODISCARD static constexpr VecType VECSEQCUPM() noexcept { return T == device::cupm::DeviceType::CUDA ? VECSEQCUDA : VECSEQHIP; }

  PETSC_NODISCARD static constexpr VecType VECMPICUPM() noexcept { return T == device::cupm::DeviceType::CUDA ? VECMPICUDA : VECMPIHIP; }

  template <typename U = Derived>
  PETSC_NODISCARD static constexpr VecType VECTYPE() noexcept {
    return U::VECTYPE_();
  }
  ...
  PETSC_NODISCARD static PetscErrorCode CUPMBlasIntCast(PetscInt x, cupmBlasInt_t *y) noexcept {
  ...
  PETSC_NODISCARD static PetscErrorCode getarray_async(Vec, PetscScalar **, PetscDeviceContext) noexcept;
  template <PetscMemType, PetscMemoryAccessMode>
  PETSC_NODISCARD static PetscErrorCode restorearray_async(Vec, PetscScalar **, PetscDeviceContext) noexcept;
  template <PetscMemoryAccessMode>
  PETSC_NODISCARD static PetscErrorCode getarrayandmemtype_async(Vec, PetscScalar **, PetscMemType *, PetscDeviceContext) noexcept;
  template <PetscMemoryAccessMode>
  PETSC_NODISCARD static PetscErrorCode restorearrayandmemtype_async(Vec, PetscScalar **, PetscDeviceContext) noexcept;
  template <PetscMemType>
  PETSC_NODISCARD static PetscErrorCode replacearray_async(Vec, const PetscScalar *, PetscDeviceContext) noexcept;

  // common ops shared between Seq and MPI
  PETSC_NODISCARD static PetscErrorCode Create_CUPM(Vec, PetscDeviceContext) noexcept;
  PETSC_NODISCARD static PetscErrorCode Create_CUPMBase(MPI_Comm, PetscInt, PetscInt, PetscInt, PetscDeviceContext, Vec *, PetscBool, PetscLayout /*reference*/ = nullptr) noexcept;
  ...
  template <typename F>
  PETSC_NODISCARD static PetscErrorCode Destroy_CUPMBase(Vec, PetscDeviceContext, F &&) noexcept;
  ...
  PETSC_NODISCARD static PetscErrorCode ResetArray_CUPMBase(Vec, F &&, PetscDeviceContext) noexcept;
  template <PetscMemType, typename F>
  PETSC_NODISCARD static PetscErrorCode PlaceArray_CUPMBase(Vec, const PetscScalar *, F &&, PetscDeviceContext) noexcept;
  ...
  PETSC_NODISCARD static auto UseCUPMHostAlloc(bool b) noexcept PETSC_DECLTYPE_AUTO_RETURNS(UseCUPMHostAlloc_<T>(b));
  PETSC_NODISCARD static auto UseCUPMHostAlloc(PetscBool b) noexcept PETSC_DECLTYPE_AUTO_RETURNS(UseCUPMHostAlloc(static_cast<bool>(b)));
  PETSC_NODISCARD static auto UseCUPMHostAlloc(Vec v) noexcept PETSC_DECLTYPE_AUTO_RETURNS(UseCUPMHostAlloc(v->pinned_memory == PETSC_TRUE));
};

// ==========================================================================================
// Vec_CUPMBase - Static Variables
// ==========================================================================================
...
PETSC_NODISCARD static PetscErrorCode VecCUPMCheckMinimumPinnedMemory_Internal(Vec v) noexcept {
...
inline PetscErrorCode Vec_CUPMBase<T, D>::getarray_async(Vec v, PetscScalar **a, PetscDeviceContext dctx) noexcept {
...
inline PetscErrorCode Vec_CUPMBase<T, D>::restorearray_async(Vec v, PetscScalar **a, PetscDeviceContext) noexcept {
  STATIC_ASSERT_THAT_ONLY_PETSC_MEMTYPE_HOST_OR_DEVICE_IS_USED(mtype);
...
inline PetscErrorCode Vec_CUPMBase<T, D>::getarrayandmemtype_async(Vec v, PetscScalar **a, PetscMemType *mtype, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
template <device::cupm::DeviceType T, typename D>
template <PetscMemoryAccessMode access>
inline PetscErrorCode Vec_CUPMBase<T, D>::restorearrayandmemtype_async(Vec v, PetscScalar **a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
...
inline PetscErrorCode Vec_CUPMBase<T, D>::replacearray_async(Vec v, const PetscScalar *a, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
  STATIC_ASSERT_THAT_ONLY_PETSC_MEMTYPE_HOST_OR_DEVICE_IS_USED(mtype);
  PetscCheckTypeNames(v, VECSEQCUPM(), VECMPICUPM());
  PetscCall(CheckPointerMatchesMemType_(a, mtype));
...
// VecCreate_CUPM()
template <device::cupm::DeviceType T, typename D>
inline PetscErrorCode Vec_CUPMBase<T, D>::Create_CUPM(Vec v, PetscDeviceContext) noexcept {
  PetscMPIInt size;
...
// VecCreateCUPM()
template <device::cupm::DeviceType T, typename D>
inline PetscErrorCode Vec_CUPMBase<T, D>::Create_CUPMBase(MPI_Comm comm, PetscInt bs, PetscInt n, PetscInt N, PetscDeviceContext, Vec *v, PetscBool call_set_type, PetscLayout reference) noexcept {
  PetscFunctionBegin;
...
template <device::cupm::DeviceType T, typename D>
template <typename F>
inline PetscErrorCode Vec_CUPMBase<T, D>::Destroy_CUPMBase(Vec v, PetscDeviceContext dctx, F &&VecDestroy_IMPLS) noexcept {
  PetscFunctionBegin;
...
inline PetscErrorCode Vec_CUPMBase<T, D>::ResetArray_CUPMBase(Vec v, F &&VecResetArray_IMPL, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
  STATIC_ASSERT_THAT_ONLY_PETSC_MEMTYPE_HOST_OR_DEVICE_IS_USED(mtype);
  PetscCheckTypeNames(v, VECSEQCUPM(), VECMPICUPM());
  // REVIEW ME:
...
template <device::cupm::DeviceType T, typename D>
template <PetscMemType mtype, typename F>
inline PetscErrorCode Vec_CUPMBase<T, D>::PlaceArray_CUPMBase(Vec v, const PetscScalar *a, F &&VecPlaceArray_IMPL, PetscDeviceContext dctx) noexcept {
  PetscFunctionBegin;
  STATIC_ASSERT_THAT_ONLY_PETSC_MEMTYPE_HOST_OR_DEVICE_IS_USED(mtype);
  PetscCheckTypeNames(v, VECSEQCUPM(), VECMPICUPM());
  PetscCall(CheckPointerMatchesMemType_(a, mtype));
