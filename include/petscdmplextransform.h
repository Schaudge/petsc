...
PETSC_EXTERN PetscErrorCode DMPlexTransformGetCellStratum(DMPlexTransform, DMPolytopeType, PetscInt *, PetscInt *);
PETSC_EXTERN PetscErrorCode DMPlexTransformGetDepth(DMPlexTransform, PetscInt *);
PETSC_EXTERN PetscErrorCode DMPlexTransformGetPointDepth(DMPlexTransform, PetscInt, PetscInt *);
