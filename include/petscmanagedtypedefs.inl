...
#define PetscManagedTypeGetArray             PetscConcat(PetscManagedType,GetArray)
...
#define PetscManagedTypeGetArrayAvailable    PetscConcat(PetscManagedType,GetArrayAvailable)
