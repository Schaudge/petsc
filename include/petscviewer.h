...
PETSC_EXTERN PetscErrorCode PetscViewerRead(PetscViewer, void *, PetscInt64, PetscInt *, PetscDataType);
...
PETSC_EXTERN PetscErrorCode PetscViewerASCIIRead(PetscViewer, void *, PetscInt64, PetscInt *, PetscDataType);
...
PETSC_EXTERN PetscErrorCode PetscViewerBinaryRead(PetscViewer, void *, PetscInt64, PetscInt *, PetscDataType);
PETSC_EXTERN PetscErrorCode PetscViewerBinaryWrite(PetscViewer, const void *, PetscInt64, PetscDataType);
PETSC_EXTERN PetscErrorCode PetscViewerBinaryReadAll(PetscViewer, void *, PetscInt64, PetscInt64, PetscInt64, PetscDataType);
PETSC_EXTERN PetscErrorCode PetscViewerBinaryWriteAll(PetscViewer, const void *, PetscInt64, PetscInt64, PetscInt64, PetscDataType);
