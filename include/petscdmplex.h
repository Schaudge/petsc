...
PETSC_EXTERN PetscErrorCode DMPlexGetCones(DM, const PetscInt *[]);
PETSC_EXTERN PetscErrorCode DMPlexGetConeOrientations(DM, const PetscInt *[]);
...
PETSC_EXTERN PetscErrorCode DMPlexGetRelativeOrientation(DM, PetscInt, const PetscInt[], const PetscInt[], PetscInt *);
