...
PETSC_EXTERN PetscErrorCode PetscSectionGetChunkMajor(PetscSection, PetscBool *);
PETSC_EXTERN PetscErrorCode PetscSectionSetChunkMajor(PetscSection, PetscBool);
