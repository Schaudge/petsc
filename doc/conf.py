...
def build_finished_handler(app, exception):
    if app.builder.name.endswith('html'):
        ...
        # fix_pydata_margins.fix_pydata_margins(app.outdir)  commented out because cannot find html/_static/styles/pydata-sphinx-theme.css
...
#   files at different levels of the directory hierarchy. file.md -> file.html with html but
#   file.md -> file/index.html with dirhtml and we want both to work correctly using relative links.
...
def _fix_links(app, exception):
    """We need to manage our own relative paths in the User's Manual for the source code files which
       ...
       We use the string PETSC_DOC_OUT_ROOT_PLACEHOLDER in URLs in the Sphinx .md files as a stand in
