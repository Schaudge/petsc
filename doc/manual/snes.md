...
method. The general form of the $n$-dimensional Newton’s method
...
Anderson Mixing methods combine the last $m$ iterates, plus a new
...
$^*$
 ...
 Use either the generic 

`MatCreate()`

 or a format-specific variant such as 
...
$^\dagger$
 ...
 Set user-defined matrix formation routine with 
