...
- ``--download-mpich-commit`` should now work as advertised, downloading MPICH via ``git`` and using the specified commit. Previously this option was silently ignored
