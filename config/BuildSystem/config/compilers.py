  ...
  def checkC99Flag(self):
    ...
    for flag in flags_to_try:
      ...
      if self.setCompilers.checkCompilerFlag(flag, includes, body):
        ...
        self.logWrite(self.setCompilers.restoreLog())
    self.setCompilers.popLanguage()
    if self.c99flag is None: raise RuntimeError('PETSc requires c99 compiler! Configure cold not determine compatible compiler flag. Perhaps you can specify via CFLAGS')
    return
