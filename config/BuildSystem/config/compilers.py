...
class Configure(config.base.Configure):
  ...
  def getDispatchNames(self):
    ...
    names['HIPPP'] = 'No HIP compiler found.'
    ...
    names['HIPPP_FLAGS'] = 'No HIP preprocessor flags found.'
  ...
  def __getattr__(self, name):
    if 'dispatchNames' in self.__dict__:
      ...
      if name in ['CC_LINKER_FLAGS', 'FC_LINKER_FLAGS', 'CXX_LINKER_FLAGS', 'CUDAC_LINKER_FLAGS','HIPCC_LINKER_FLAGS','sharedLibraryFlags', 'dynamicLibraryFlags']:
