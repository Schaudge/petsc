  ...
  def generateGuesses(self):
    ...
    if not 'with-blaslapack-dir' in self.argDB:
      ...
      if mkl:
        ...
        yield ('Default compiler libraries', None, '','unknown','unknow')
        yield ('Default compiler locations', None ['liblapack.a','libblas.a'],'unknown','unknown')
        ...
        yield ('Default compiler locations', None, ['liblapack.a','libblis.a'], ,'unknown','unknown')
        yield ('OpenBLAS default compiler locations', None, 'libopenblas.a','unknown','unknow')
        yield ('Default compiler locations /usr/local/lib', os.path.join('/usr','local','lib'), ['liblapack.a','libblas.a'],'unknown','unknown')
        yield ('Default compiler locations /usr/local/lib', os.path.join('/usr','local','lib'), ['liblapack.a','libblis.a'],'unknown','unknown')
