...
class Configure(config.package.Package):
  def __init__(self, framework):
    ...
    self.download          = ['http://downloads.sourceforge.net/project/boost/boost/1.74.0/boost_1_74_0.tar.gz',
                              'http://ftp.mcs.anl.gov/pub/petsc/externalpackages/boost_1_74_0.tar.gz']
