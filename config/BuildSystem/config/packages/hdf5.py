...
class Configure(config.package.GNUPackage):
  def __init__(self, framework):
    ...
    self.download         = ['https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-1.14/hdf5-1.14.0/src/hdf5-1.14.0.tar.bz2',
                             'http://ftp.mcs.anl.gov/pub/petsc/externalpackages/hdf5-1.14.0.tar.bz2']
