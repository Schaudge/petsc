...
class Configure(config.package.GNUPackage):
  def __init__(self, framework):
    ...
    self.download               = ['https://download.open-mpi.org/release/open-mpi/v4.1/openmpi-4.1.1.tar.gz',
                                   'http://ftp.mcs.anl.gov/pub/petsc/externalpackages/openmpi-4.1.1.tar.gz']
