...
class Preprocessor(config.compile.processor.Processor):
  ...
  def __init__(self, argDB):
    config.compile.processor.Processor.__init__(self, argDB, 'HIPPP', 'HIPPP_FLAGS', '.cpp', '.c')
    self.language        = 'HIP'
...
class Compiler(config.compile.processor.Processor):
  ...
  def __init__(self, argDB, usePreprocessorFlags = True):
    config.compile.processor.Processor.__init__(self, argDB, 'HIPCC', 'HIPCC_FLAGS', '.hip.cpp', '.o')
    self.language        = 'HIP'
